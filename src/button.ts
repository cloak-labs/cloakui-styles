...
export const buttonStyles = cva({
  ...
  variants: {
    variant: {
      ...
      outline:
        "text-root border border-root-dim bg-transparent shadow-sm hover:bg-root-dim hover:text-root-dim",
      secondary:
        "bg-root-dim text-root-vivid shadow-sm border border-root-dim hover:bg-root-dim/80",
